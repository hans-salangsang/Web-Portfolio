...
function ExperienceSection({ Typography, Chip }, ref) {
  ...
  return (
    <Container maxWidth={screenSize === "xl" ? "xl" : "lg"}>
      {screenSize === 'xs' && (
        <Grid ref={ref} container sx={{ minHeight: '100vh', pt: '20vh', pb: '10vh' }}>
            ...
            <Grid container item>
              <Grid item xs={12}>
                <ScrollRevealAnimation spring={true} reveal={true}>
                  <Typography variant="h4" color="text.textPrimary.light" fontWeight={400} sx={{ mb: 3 }}>Projects</Typography>
      ...
      {screenSize !== 'xs' && (
        <Grid ref={ref} container sx={{ minHeight: '100vh', pt: '30vh', pb: '20vh' }}>

          <Grid container item xs={5}>
            <Grid item xs={12}>
              <ScrollRevealAnimation spring={true} reveal={true} zIndex={2}>
                <Parallax speed={-15}>
                  <Typography variant="h4" color="text.textPrimary.light" fontWeight={400} sx={{ mt: screenSize === "xs" ? 27 : screenSize === "xl" ? 28 : 16 }}>Projects</Typography>
                </Parallax>
              </ScrollRevealAnimation>
            </Grid>
          </Grid>
