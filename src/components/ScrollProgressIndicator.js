    ...
    >
      <Tooltip title="Home" placement="left">
        <CustomChip
          ...
          sx={{ maxHeight: activeSection === "landing" ? "30px" : "6px" }}
        />
      </Tooltip>
      ...
      <Tooltip title="Experience" placement="left">
        <CustomChip
          ...
          sx={{ maxHeight: activeSection === "experience" ? "30px" : "6px" }}
        />
      </Tooltip>
      ...
      <Tooltip title="Projects" placement="left">
        <CustomChip
          ...
          sx={{ maxHeight: activeSection === "projects" ? "30px" : "6px" }}
        />
      </Tooltip>
      ...
      <Tooltip title="Connect" placement="left">
        <CustomChip
          ...
          sx={{ maxHeight: activeSection === "connect" ? "30px" : "6px" }}
        />
      </Tooltip>
    </Stack>
  );
