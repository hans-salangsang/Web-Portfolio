...
function LandingSection({ Typography }, ref) {
  ...
  return (
    <Container maxWidth={screenSize === "xl" ? "xl" : "lg"} ref={ref} sx={{ minHeight: '100vh', pt: screenSize === "xs" ? "0vh" : "36vh", pb: '15vh' }}>
      {/* <Stack spacing={2} ref={scope}> */}
      <Stack spacing={2}>

        {screenSize === 'xs' && (
          <ScrollRevealAnimation spring={true} reveal={true} zIndex={2}>
              <Typography variant="h2" color="text.textPrimary.light" fontWeight={800} paragraph textAlign="left" sx={{ pt: '20vh' }}>
                Hans<br />Salangsang
        ...
        <ScrollRevealAnimation spring={true} reveal={true}>
            <Typography variant="body2" color="text.textPrimary.main" fontWeight={400} paragraph textAlign="right" sx={{ mt: screenSize === "xs" ? "22vh" : screenSize === "xl" ? "25vh" : "18vh" }}>
              {screenSize === 'xs' && (
                <>
